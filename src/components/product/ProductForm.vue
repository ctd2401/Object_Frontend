  ...
  <div class="grid grid-cols-10 gap-4">
    ...
    <div class="card col-span-3 mb-0">
      <div class="border shadow-md rounded-xl w-full min-h-[260px] flex justify-center items-center relative">
        ...
        <!-- <FileUpload v-if="!src && !product?.image" mode="basic" chooseLabel="Chọn ảnh cửa hàng"
      ...
      <FileUpload v-if="src || product?.image" mode="basic" chooseLabel="Thay đổi ảnh" class="p-button-outlined self-center mt-4" accept="image/*" customUpload auto @select="onFileSelect" />
    </div>
  </div>
</template>
